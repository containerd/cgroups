...
type MemoryStat struct {
	...
	Usage                 *MemoryEntry `protobuf:"bytes,32,opt,name=usage,proto3" json:"usage,omitempty"`
	SwapUsage             *MemoryEntry `protobuf:"bytes,33,opt,name=swap_usage,json=swapUsage,proto3" json:"swap_usage,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}     `json:"-"`
	XXX_unrecognized      []byte       `json:"-"`
	XXX_sizecache         int32        `json:"-"`
}
...
var fileDescriptor_2fc6005842049e6b = []byte{
	...
	,
}
...
func (m *MemoryStat) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SwapUsage != nil {
		...
		dAtA[i] = 0x2
		i++
		i = encodeVarintMetrics(dAtA, i, uint64(m.SwapUsage.Size()))
		n5, err := m.SwapUsage.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (this *MemoryStat) String() string {
	...
	s := strings.Join([]string{`&MemoryStat{`,
		...
		`SwapUsage:` + strings.Replace(fmt.Sprintf("%v", this.SwapUsage), "MemoryEntry", "MemoryEntry", 1) + `,`,
		`XXX_unrecognized:` + fmt.Sprintf("%v", this.XXX_unrecognized) + `,`,
		`}`,
	}, "")
	return s
